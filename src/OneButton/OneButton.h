...
public:
   ...
   */
  OneButton(int pin, boolean activeLow = true, bool pullupActive = true, PCF8574 * expander = NULL);
  ...
  void attachStartPress(parameterizedCallbackFunction newFunction, void* parameter);
  void attachStopPress(parameterizedCallbackFunction newFunction, void* parameter);
...
private:
  ...
  parameterizedCallbackFunction _paramStartPressFunc = NULL;
  void* _startPressFuncParam = NULL;

  parameterizedCallbackFunction _paramStopPressFunc = NULL;
  void* _stopPressFuncParam = NULL;
